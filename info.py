...
API_ID = int(environ('API_ID', '9411723'))
API_HASH = environ('API_HASH', '30fa091455c0548d77dc254f0bb705b0')
BOT_TOKEN = environ('BOT_TOKEN', '5792604981:AAFPd65l_192jCtMCpVnntrUqB5Vn1Au8jk')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001805346080')).split()]
